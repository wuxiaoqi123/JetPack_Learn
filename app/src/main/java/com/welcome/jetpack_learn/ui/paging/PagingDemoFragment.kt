...
class PagingDemoFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        btn_paging_dao.setOnClickListener {
            findNavController().navigate(R.id.pagingWithDaoActivity)
        }
        btn_paging_net.setOnClickListener {
            findNavController().navigate(R.id.pagingWithNetWorkActivity)
        }
    }
}